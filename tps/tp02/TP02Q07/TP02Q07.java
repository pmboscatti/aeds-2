...
class Lista {
    ...
    // Conferir o nome dos personagens recebidos com os existentes
    public void confereNome(String nomeRecebido) {
    ...
    public void criarLog(long tempoInicial) {
        ...
        Arq.println(
                "Matricula: 790052\t" + "Tempo Execucao: " + (tempoFinal - tempoInicial) + "ms\t Numero Comparacoes: "
                        + numeroComparacoes);
        Arq.close();
    }
}
...
public class TP02Q07 {
    public static void main(String[] args) throws Exception {
        ...
        String nomePersonagem = MyIO.readLine().replaceAll("é", "\u00e9");

        // Testar fim da segunda parte do arquivo
        while (testaFim(nomePersonagem) == false) {

            listaPersonagens.confereNome(nomePersonagem);
